...
export default function (view, params) {
    ...
    view.addEventListener('viewshow', function () {
        ...
        page.querySelector('.lnkDevToolsPreferences').setAttribute('href', '#!/mypreferencesdevtools.html?userId=' + userId);
        ...
        if (params.userId && params.userId !== Dashboard.getCurrentUserId) {
            ...
            page.querySelector('.lnkDevToolsPreferences').classList.add('hide');
        }
